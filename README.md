...
* Interface gráfica / dashboard visual (estilo Trello): foi considerado durante o planejamento, mas não foi implementado por limitações de tempo. O foco se manteve na lógica de negócio e na funcionalidade do código.
...
Descricao: Usar lovable com auxilio dos membros da T.I.
...
* A programacao defensiva foi revisada e reforcada nas sprints finais apos revisao conjunta do codigo, resultando em validacoes mais robustas em `Tarefa.cpp` e `AgileManager.cpp`.